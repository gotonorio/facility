...
from repair_plan_cycle.form import (
    DeleteKoujiCycleDataForm,
    DuplicateKoujiCycleDataForm,
    KoujiCycleDataForm,
...
class DuplicateKoujiCycleDataView(PermissionRequiredMixin, generic.FormView):
    """BasicPlanData の version を丸ごと複製するビュー"""

    form_class = DuplicateKoujiCycleDataForm
    template_name = "koujicycledata_duplicate_form.html"
    success_url = reverse_lazy("repair_plan_cycle:cycledata_list")
    permission_required = "repair_plan.add_koujiname"

    # def get(self, request, *args, **kwargs):
    #     form = DuplicateKoujiCycleDataForm()
    ...
    def post(self, request, *args, **kwargs):
        form = DuplicateKoujiCycleDataForm(request.POST)
...
class DeleteKoujiCycleDataView(PermissionRequiredMixin, generic.FormView):
    """指定されたversionのKoujiCycleDataを削除する"""

    template_name = "repair_plan_cycle/koujicycledata_delete_form.html"
    form_class = DeleteKoujiCycleDataForm
    # 必要な権限（管理者権限）
    permission_required = "repair_plan.add_koujiname"
    success_url = reverse_lazy("repair_plan_cycle:cycledata_list")
