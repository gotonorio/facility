        ...
        context.update(
            {
                ...
                "form": RepairPlanListForm(
                    self.is_manager, self.version_obj, initial={"koujitype": self.koujitype_param}
                ),
...
class RepairPlanByYearView(PermissionRequiredMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update(
            {
                # "repairplan_by_year": self.repair_plan,
                "total": self.total,
                "start_year": -settings.INITIAL_YEAR,
            }
        )
        ...
        context.update(
            {
                ...
                "form": RepairPlanListForm(
                    self.is_manager, self.version_obj, initial={"version": self.version_obj}
                ),
                "start_year": -settings.INITIAL_YEAR,
            }
        )
